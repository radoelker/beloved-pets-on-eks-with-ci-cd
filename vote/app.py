...
result_host = os.getenv('RESULT_HOST','result-app') # to display result website
result_port = int(os.getenv('RESULT_PORT', 5001))
...
def hello():
    ...
    # This will only get executed (vote will only exist) once you click cat/dog
